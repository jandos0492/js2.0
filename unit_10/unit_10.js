...
let ar3 = ["a", 4, true, false, "man"];

function f3() {
    let out_3 = document.querySelector('.out-3');
    out_3.innerHTML = ar3.length;
}
...
function f8() {
    ...
    let out_81 = document.querySelector('.out-8-1');
    let str_8 = "";
    for (let i = 0; i < ar8.length; i++) {
        str_8 += ar8[i] + "-";
    }
    out_8.innerHTML = str_8;
    out_81.innerHTML = "Array length is: " + ar8.length;
}
...
function f9() {
    ...
    out_9.innerHTML = ar9[ar9.length - 1];
}
...
function f16() {
    ...
    for (let i = 0; i < ar16_even.length; i++) {
        str_even += ar16_even[i] + " ";
    }
    for (let i = 0; i < ar16_odd.length; i++) {
        str_odd += ar16_odd[i] + " ";
    }
    even.innerHTML = str_even;
    odd.innerHTML = str_odd;
}
