...
function f15() {
    ...
    let arr_length = a15[0].length;
    for (let i = 0; i < a15.length; i++) {
        if (a15[i].length > arr_length) {
            arr_length = a15[i].length;
        }
    }
    out_15.innerHTML = arr_length;
}
