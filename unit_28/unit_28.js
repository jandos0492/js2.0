...
let goods = new Goods("Iphone", "$999", "img/1.png", 150);
// console.log(goods);
goods.draw(document.querySelector('.out-3'));
 ...
 let goods2 = new Goods("Ipad Pro", "$1100", "img/2.png", 820);
...
let goods3 = new Goods2("Macbook Pro", "$1500", "img/3.png", 270, true);
...
let task8 = new Valid("jack@gmail.com", "Hello", false);
task8.validate();
console.log(task8.isValid);
 ...
 let task9 = new Valid("johny@gmail.com", "HelloMoto", false);
 task9.validate();
 console.log(task9.isValid);
 ...
 let valid3 = new Valid2("monica@gmail.com", "12345678", false);
 valid3.validate();
