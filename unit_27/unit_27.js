...
function t2() {
    let a = new Promise((resolve, reject) => {
        fetch("http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=10&num2=15")
            .then(response => resolve(response.text()));
    });
    
    let b = new Promise((resolve, reject) => {
        fetch("http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=7&num2=15")
            .then(response => resolve(response.text()));
    });
...
function t3() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch("http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=999&num2=209")
            .then(response => resolve(response.text()));
    });
...
function t6() {
    let a = new Promise((resolve, reject) => {
        fetch("http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=12&num2=21", {
            method: "POST",
            headers: {
                "Content-type": "application/x-www-form-urlencoded",
            },
            body: "auth=5ADcB96BA48d3f80&action=3&num1=12&num2=21",
        })
            .then(response => resolve(response.text()));
    })
    
    let b = new Promise((resolve, reject) => {
        fetch("http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=12&num2=21", {
            method: "POST",
            headers: {
                "Content-type": "application/x-www-form-urlencoded",
            },
...
function t7() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch("http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=11&num2=210", {
            method: "POST",
            headers: {
                "Content-type": "application/x-www-form-urlencoded",
            },
