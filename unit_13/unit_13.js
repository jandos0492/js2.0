...
function f3() {
    ...
    out_3.innerHTML = `${a3.five} ${a3.odd}`;
...
function f19() {
    ...
    i_19 = i_19.charAt(0).toUpperCase() + i_19.slice(1, i_19.length);
    let str_19 = "";
    for (let key in a19) {
