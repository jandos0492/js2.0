...
function f4() {
    ...
    if (i_4.checked) {
        out_4.innerHTML = "true";
    }
    else {
        out_4.innerHTML = "false";
    }
}
...
function f7() {
    ...
    let out_71 = document.querySelector(".out-71");
    let out_72 = document.querySelector(".out-72");
    if (i_7.length >= 6) {
        out_71.innerHTML = i_7;
        out_72.innerHTML = "1";
    }
    else {
        out_71.innerHTML = i_7;
...
function f8() {
    ...
    out_8.innerHTML = '<input class="i-81"> <button class = "b-81">Button</button>  <br> <div class="out-81"></div>';
    function f81 () {
        let out_81 = document.querySelector(".out-81");
        out_81.innerHTML = document.querySelector('.i-81').value;
...
function f9() {
    ...
    if (r_9.checked) {
        out_9.innerHTML = r_9.value;
        r_9.checked = r_9.unchecked;
    }
    else {
        out_9.innerHTML = "0";
    }
...
function f11() {
    let i_111 = document.querySelector(".i-111").value;
...
function f15() {
    ...
    t_15.innerHTML = i_15.value;
    out_15.innerHTML = i_15.value;
...
function f17() {
    let sel2 = document.querySelector('.s-17').value;
    let out_17 = document.querySelector('.out-17');
    out_17.innerHTML = sel2;
}
...
function f18() {
    let sel3 = document.querySelector('.s-18').value;
    document.querySelector('.i-18').value = sel3;
}
...
function f19() {
    let i_191 = document.querySelector('.i-191').value;
    let i_192 = document.querySelector('.i-192').value;
    let out_19 = document.querySelector('.out-19');
    out_19.innerHTML = i_191 + " " + i_192;
}
...
function f20(e) {
    ...
    let passw = form.elements["password"].value;
    let out_20 = document.querySelector('.out-20');
    out_20.innerHTML = user + " " + passw;
}
