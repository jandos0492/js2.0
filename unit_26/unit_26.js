...
function t2() {
	fetch("http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=2&name=Zhandos")
	.then(response => response.text())
	.then(response => {
...
function t3() {
	fetch("http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=5&num2=25")
	.then(response => response.text())
	.then(response => {
...
function t4() {
	fetch("http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=12&num2=29")
	.then(response => response.text())
	.then(response => {
...
function t6() {
	fetch("http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=20&num2=18")
		.then(response => response.text())
		.then(response => {
...
function t11() {
	fetch("http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=2&name=Zhandos", {
		...
		body: "auth=5ADcB96BA48d3f80&action=2&name=Zhandos",
	})
		.then(response => response.text())
		.then(response => {
...
function t12() {
	fetch("http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=14&num2=15", {
		method: "POST",
		headers: {
			"Content-type": "application/x-www-form-urlencoded",
		},
		body: "auth=5ADcB96BA48d3f80&action=3&num1=14&num2=15",
	})
		.then(response => response.text())
		.then(response => {
...
function t13() {
	fetch("http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=1&num2=15", {
		method: "POST",
		headers: {
			"Content-type": "application/x-www-form-urlencoded",
		},
		body: "auth=5ADcB96BA48d3f80&action=4&num1=1&num2=15",
	})
		.then(response => response.text())
		.then(response => {
...
function t15() {
	fetch("http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=298&num2=20", {
		method: "POST",
		headers: {
			"Content-type": "application/x-www-form-urlencoded",
		},
		body: "auth=5ADcB96BA48d3f80&action=6&num1=298&num2=20",
	})
		.then(response => response.text())
		.then(response => {
...
function t17() {
	fetch("http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=8&year=1992", {
		...
		body: "auth=5ADcB96BA48d3f80&action=8&year=1992",
	})
		.then(response => response.text())
		.then(response => {
