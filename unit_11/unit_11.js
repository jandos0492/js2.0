...
function f11() {
    ...
    let i_11 = parseInt(document.querySelector('.i-11').value);
    out_11.innerHTML = d11.indexOf(i_11);
}
...
function f12() {
    ...
    i_12 = parseInt(document.querySelector('.i-12').value);
    let temp = -1;
...
function f13() {
    ...
    for (let i = d13.length - 1; i >= 0; i--) {
        my_reverse[(d13.length - 1) - i] = d13[i]
    }
    d13 = my_reverse;
    showArr('.out-13', d13);
}
...
function f14() {
    let i_14 = parseInt(document.querySelector('.i-14').value);
...
function f15() {
    let i_15 = parseInt(document.querySelector('.i-15').value);
...
function f18() {
    ...
    out_18.innerHTML = d18.includes(i_18);
}
...
function f19() {
    ...
    for (let i = 0; i < d19.length; i++) {
        if (d19[i].length > temp_str.length) {
            temp_str = d19[i];
        }
    }
    maxString = temp_str;
    out_19.innerHTML = maxString;
}
